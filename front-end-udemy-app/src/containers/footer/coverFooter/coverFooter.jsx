    ...
    return (
        <div className='cover-footer' style={{ backgroundImage: `url(${cover})` }}>
            ...
            <div className='leaves'>
                ...
                <div className='leaves__item'><img src={leave3}></img></div>
                <div className='leaves__item'><img src={leave4}></img></div>
                <div className='leaves__item'><img src={leave5}></img></div>
                <div className='leaves__item'><img src={leave2}></img></div>
                <div className='leaves__item'><img src={leave6}></img></div>
                <div className='leaves__item'><img src={leave4}></img></div>
            </div>
