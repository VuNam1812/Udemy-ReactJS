        ...
        <div className="footer">
            ...
            <div className='wrap'>
                            ...
                            return (
                                <div className='col--1--of--5'>
                                    ...
                                    <div className='content__links'>
                                        ...
                                        {item.data.map((text) => {
                                            return (<div className='content content--hover'>
                    ...
                    <div className='col--2--of--5'>
                        ...
                        <div className='content__links'>
                            ...
                            <div className='content'>
                                <a href='#'><p className='text' style={{ fontSize: '1.1rem' }}>MyEdu is open-source and free to the community. Your donations
                                                go a long way towards making that possible.</p></a>
                            </div>
                            <div className='content'>
                                <a href='#'>
                                    <div className='text' style={{
                                        fontSize: '1rem', color: '#05c0a5',
                                        display: 'flex', marginBottom: '1rem',
                                        alignItems: 'center'
                                    }}>
                                        <i class="fa fa-youtube-play fa-2x" style={{ color: 'red', marginRight: '0.5rem' }} aria-hidden="true"></i>
                                        <span> Youtube</span>
                                    </div>
                                </a>
                            </div>
                            <div className='content'>
                                <a href='#'>
                                    <div className='text' style={{ fontSize: '1rem', color: '#05c0a5', display: 'flex', alignItems: 'center' }}>
                                        <i class="fa fa-facebook-square fa-2x" style={{ color: 'darkBlue', marginRight: '0.5rem' }} aria-hidden="true"></i>
                                        <span> Facebook</span>
                                    </div>
                                </a>
                            </div>
                ...
                <div className='footer__notes row'>
                    <div>
                        <p>Pricing taken from </p><span>VuNam</span>
                    </div>
